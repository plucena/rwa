...
[`PRIVACY-IMPLEMENTATION.md`](PRIVACY-IMPLEMENTATION.md) first — every finding below is
...
([`PRIVACY-IMPLEMENTATION.md`](PRIVACY-IMPLEMENTATION.md) §4.3). With two funds and a
...
in the code that grants it ([`PRIVACY-IMPLEMENTATION.md`](PRIVACY-IMPLEMENTATION.md)
...
- **The remediation path is broken.** `forcedTransfer` and `batchForcedTransfer` take
  ...
  ([`PRIVACY-IMPLEMENTATION.md`](PRIVACY-IMPLEMENTATION.md) §7.1). If a holder *were*
...
disclosure in its own header comment, and `PRIVACY-IMPLEMENTATION.md` §6 states it. EPIC
